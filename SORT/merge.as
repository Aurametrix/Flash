/*****************************************
* Merge Sort
* O(n log n) comparison-based sorting - a divide and conquer algorithm.  
* Most implementations produce a stable sort, preserveing the input order of equal elements in the sorted output. 
* Best for linked lists, large arrays
* Worst for storage complexity
****************************************/
